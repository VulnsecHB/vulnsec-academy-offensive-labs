#!/usr/bin/env python3
"""Atlas Mission Control for Salt Gate (flag drop only)."""
...
TARGET_IP = "10.23.54.144"
LAB_ID = "ch-03-salt-gate"
FLAGS = {
    "user": "CH{salt_gate_user}",
    "root": "CH{salt_gate_root}",
}
...
def preview_state() -> dict[str, Any]:
    return {"session_id": "preview-ch-03-salt-gate", "target_ip": TARGET_IP, "port": 80}
