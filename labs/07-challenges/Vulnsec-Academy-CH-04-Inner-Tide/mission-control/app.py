#!/usr/bin/env python3
"""Atlas Mission Control for Inner Tide (flag drop only)."""
...
TARGET_IP = "10.23.54.151"
LAB_ID = "ch-04-inner-tide"
FLAGS = {
    "user": "CH{inner_tide_user}",
    "root": "CH{inner_tide_inner}",
}
...
def preview_state() -> dict[str, Any]:
    return {"session_id": "preview-ch-04-inner-tide", "target_ip": TARGET_IP, "port": 22}
