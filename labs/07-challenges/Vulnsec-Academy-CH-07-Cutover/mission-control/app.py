#!/usr/bin/env python3
"""Atlas Mission Control for Cutover (flag drop only)."""
...
LAB_ID = "ch-07-cutover"
FLAGS = {
    "user": "CH{cutover_user}",
    "root": "CH{cutover_root}",
}
...
def preview_state() -> dict[str, Any]:
    return {"session_id": "preview-ch-07-cutover", "target_ip": TARGET_IP, "port": 80}
