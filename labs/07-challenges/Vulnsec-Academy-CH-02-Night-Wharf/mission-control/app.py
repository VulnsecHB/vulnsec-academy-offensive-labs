#!/usr/bin/env python3
"""Atlas Mission Control for Challenge 02 — Night Wharf (flag drop only)."""
...
TARGET_IP = "10.23.54.163"
FLAGS = {
    "user": "SQLI{night_wharf_user_reeves}",
    "root": "SQLI{night_wharf_root_hold}",
}
...
FLAG_META = [
    {
        ...
        "helper": "Usually recovered after you have a shell as the field operator.",
        "placeholder": "SQLI{...}",
    ...
    },
    {
        ...
        "helper": "Usually recovered after privilege escalation on the field node.",
        "placeholder": "SQLI{...}",
        "success": "Root flag accepted. Mission complete — walkthrough access granted.",
...
def preview_state() -> dict[str, Any]:
    return {"session_id": "preview-night-wharf", "target_ip": TARGET_IP, "port": 80}
...
class MissionControlHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:  # noqa: N802
        ...
        self.send_json({"correct": correct, "message": meta["success"] if correct else meta["error"]})
