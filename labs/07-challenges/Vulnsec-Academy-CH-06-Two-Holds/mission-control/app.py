#!/usr/bin/env python3
"""Atlas Mission Control for Two Holds (flag drop only)."""
...
LAB_ID = "ch-06-two-holds"
FLAGS = {
    "user": "CH{two_holds_user}",
    "root": "CH{two_holds_root}",
}
...
def preview_state() -> dict[str, Any]:
    return {"session_id": "preview-ch-06-two-holds", "target_ip": TARGET_IP, "port": 22}
